...
class Searcher
{
	...
	public static function search($search = '', $pageIndex = 0, $size = 10, $facets = array(), $sortByDate = false)
	{
		...
		$match_query = Config::option('enable_match_query');
		if ($match_query) {
			// Skip the setting of Fantastic Elasticsearch and use match query.

			// 2017-12-19 fukushima
		...
		// return self::_query($search_str, $pageIndex, $size, $sortByDate);
	}
	...
	// public static function _query($search_str, $pageIndex, $size, $sortByDate = false)
	{
