	...
	function render(){
		...
		echo '<fieldset>';
			...
			foreach( $this->field['options'] as $k => $v) {
				...
				echo '<input type="checkbox" id="' . $this->field['id'] . '_' . array_search($k, array_keys($this->field['options'])) . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $k . ']" ' . $class . ' value="1" ' . checked(isset($this->value[$k]), true, false) . '/>';
